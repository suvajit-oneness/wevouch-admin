    ...
    <div class="page" style="margin-top: 100px;" id="DivIdToPrint">
        ...
        <table class="border0">
            <tr>
                <td  class="border0">
                    <p>
                        This non judicial stamp paper of Rs 50/- (Rupees Fifty) is part & parcel of the Undertaking cum Indemnity for payment of differential stamp duty dated {{$data->dateofagreement}} executed by the Borrower {{$data->prefixoftheborrower}} {{$data->nameoftheborrower}} {{$coBorrowerDetails}} {{$coBorrower2Details}} in respect of Loan Account No. {{$data->loanaccountnumber}}.
                    </p>
                </td>
            </tr>
        </table>
