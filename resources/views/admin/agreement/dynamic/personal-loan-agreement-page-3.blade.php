...
<body>
    ...
    @php
        ...
        if ( !empty($data->prefixofthecoborrower) && !empty($data->nameofthecoborrower) ) {
            $coBorrowerDetails = 'Co-Borrower '.$data->prefixofthecoborrower.' '.$data->nameofthecoborrower;
        }
    ...
    <div class="page" style="margin-top: 100px;" id="DivIdToPrint">
        ...
        <table class="border0">
            <tr>
                <td  class="border0">
                    <p>
                        This non judicial stamp paper of Rs 100/- (Rupees one hundred) is part & parcel of the <b>Personal Loan Agreement</b> dated {{$data->dateofagreement}} signed between the Borrower {{$data->prefixoftheborrower}} {{$data->nameoftheborrower}} {{$coBorrowerDetails}} {{$coBorrower2Details}} and {{$guarantorDetails}} Lender M/s Peerless Financial Services Limited in respect of <b>Loan Account No.</b> {{$data->loanaccountnumber}}.
                    </p>
                </td>
            </tr>
        </table>
