    ...
    <div class="page" style="margin-top: 100px;" id="DivIdToPrint">
        ...
        <table class="border0">
            <tr>
                <td  class="border0">
                    <p>
                        This non judicial stamp paper of Rs 10/- (Rupees Ten) is part & parcel of the PDC Letter Cum Undertaking dated {{$data->dateofagreement}} executed by the Borrower {{$data->prefixoftheborrower}} {{$data->nameoftheborrower}} {{$coBorrowerDetails}} {{$coBorrower2Details}} in respect of Loan Account No. {{$data->loanaccountnumber}}.
                    </p>
                </td>
            </tr>
        </table>
