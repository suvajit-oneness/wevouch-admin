                        ...
                        @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('employee_id') {{'is-invalid'}} @enderror" id="employee_id" name="employee_id" placeholder="Employee id" value="{{old('employee_id') ? old('employee_id') : $data->user->emp_id}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('phone_number') {{'is-invalid'}} @enderror" id="phone_number" name="phone_number" placeholder="Phone number" value="{{old('phone_number') ? old('phone_number') : $data->user->mobile}}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="office" id="office" class="form-control @error('office') {{'is-invalid'}} @enderror">
                                        ...
                                        @foreach ($data->offices as $item)
                                            <option value="{{$item->id}}" {{($data->user->office_id == $item->id) ? 'selected' : ''}}>{{$item->name}}</option>
                                        @endforeach
                                    </select>
