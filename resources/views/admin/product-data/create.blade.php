...
@section('title', 'Create Product data')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="{{ route('user.product.data.store') }}" id="profile-form">
                            @csrf
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group mt-2">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="service_type" name="service_type" value="1">
